...
export default function TextUnderBanner() {
  ...
  return (
    <Container mt={50} mb={50}>
      <Title order={1}>
        Our blueprint for digital transformation below gives an overview of the
        sequence, checklist, and guides at all levels of the organization
        through the journey ensuring that no area of the strategy is left
        unattended during the period of change:
      </Title>
      <SimpleGrid
        cols={2}
        spacing='xl'
